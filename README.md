...
- 🎯 **[meta-agent](https://github.com/rishi-ie/meta-agent)** — Modular extension system for pi. Create extensions, fills, and prompts via config files. Turn pi into whatever you need.
